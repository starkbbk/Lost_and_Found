        ...
        <div class="col-lg-8">
            <div class="glass-card p-5">
                <div class="text-center mb-5">
                    <h1 class="display-5 fw-black text-accent-glow mb-2">Post Found Item</h1>
                    <p class="text-muted">Fill in the details below to help someone find their lost belongings.</p>
                ...
                <form action="" id="item-form">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label for="fullname" class="form-label fw-bold text-accent-glow small text-uppercase letter-spacing-1">Founder Name</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="4" name="description" id="description" class="form-control glass-input" placeholder="Provide details about where and when you found the item..." required><?php echo isset($description) ? $description : ''; ?></textarea>
                        </div>

                        <div class="col-md-12">
                            <label class="form-label fw-bold text-accent-glow small text-uppercase letter-spacing-1">Item Image</label>
                        ...
                        <div class="col-md-12 mt-5">
                            <button type="submit" form="item-form" class="btn btn-primary btn-lg w-100 py-3 shadow-glow">
                                <i class="bi bi-send-fill me-2"></i> Submit Found Item Report
                            </button>
                        </div>
                    </div>
                </form>
